...
if __name__ == "__main__":
    ...
    # make Npass figure
    plt.figure()
    plt.hist(Npass0, Ntoss+1, density=True, facecolor='m', alpha=0.5, label="assuming $\\mathbb{H}_0$")
    if haveH1:
        plt.hist(Npass1, Ntoss+1, density=True, facecolor='b', alpha=0.7, label="assuming $\\mathbb{H}_1$")
        plt.legend()
    ...
    # make LLR figure
    plt.figure()
    plt.hist(LogLikeRatio0, Ntoss+1, density=True, facecolor='r', alpha=0.5, label="assuming $\\mathbb{H}_0$")
    if haveH1:
